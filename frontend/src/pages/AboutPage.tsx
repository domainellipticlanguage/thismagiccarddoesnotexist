  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {[
          { title: "Card Design", desc: "An LLM (Groq's openai/gpt-oss-120b by default) drafts the card using a structured-output schema, including multi-face layouts like transform, MDFC, split, saga, class, and battle." },
          { title: "Art Generation", desc: "Replicate's prunaai/p-image generates each face's artwork from a prompt; p-image-edit handles fine-grained edits and art-swap between linked faces." },
          { title: "Card Rendering", desc: "mtg-crucible renders the canonical MTG card frame in WebP. Open source — built alongside this project." },
          { title: "Infrastructure", desc: "AWS Lambda + Function URL behind a CloudFront router, fronted via SST. DynamoDB for card records, S3 for art and rendered images." },
        ].map((item) => (
